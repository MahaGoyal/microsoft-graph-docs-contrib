...
|deltaExcludeParent| String. If this request header is included, response will have only items which are actually changed, not their parent items which are coming in response just because of hierarchy.|
